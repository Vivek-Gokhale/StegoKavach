...
function encodeMessage() {
  ...
  // Trigger download of the encrypted image
  downloadImage($messageCanvas[0]);
}

function downloadImage(canvas) {
  var link = document.createElement('a');
  link.download = 'encoded_image.png'; // Default file name
  link.href = canvas.toDataURL('image/png'); // Convert canvas to image data
